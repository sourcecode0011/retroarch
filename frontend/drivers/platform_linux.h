...
struct android_app
{
   ...
   jmethodID getIntent;
   //初始化完成调用
   jmethodID onRetroArchEvent;
   jmethodID onRetroArchUSBControl;
   ...
   jmethodID onRetroArchInitPCM;
   jmethodID onRetroArchOpenAudio;
   jmethodID onRetroArchCloseAudio;
   jmethodID onRetroArchPlayPCM;
};
